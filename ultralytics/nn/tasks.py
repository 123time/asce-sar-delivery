...
from ultralytics.nn.extra_modules import DySample, EMA, EMAAttention, FMKernel, SPDConv, SWC
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):
        ...
        if m in base_modules:
            ...
            if m in repeat_modules:
                args.insert(2, n)
                n = 1
            if m in ((C3k2,) + C3K2_CLASS) and scale in "mlx":
                args[3] = True
            if m is A2C2f and scale in "lx":
        ...
        elif m in {EMAAttention, SpatialAttention, CBAM, DySample, FMKernel}:
            c2 = ch[f]
            args = [c2, *args]
        else:
            c2 = ch[f]
